...
from CNN_Classifier.entity.config_entity import DataIngestionCongig, EvalConfig, PrepareBaseModelConfig, PrepareCallbacksConfig, TrainingConfig
...
class ConfigurationManager:
    ...
    def get_validation_config(self) -> EvalConfig:
